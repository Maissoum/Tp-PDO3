...
<html lang="en">
  <head>
    ...
    <script src="https://kit.fontawesome.com/8ae7189ac9.js" crossorigin="anonymous"></script>
      ...
      <ul class="navbar-nav mr-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="listeGenre.php">Ajouter un genre</a>
          </div>
        </li>
        <li class="nav-item dropdown">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown01">
              ...
              <a class="dropdown-item" href="listeNationalites.php">Ajouter une nationalité</a>
            </div>
        </li>
      </ul>
    </div>
